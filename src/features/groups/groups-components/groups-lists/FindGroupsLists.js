...
const FindGroupsLists = () => {
  return (
    <div className='flex items-center justify-between py-1 border-b border-emerald-700 border-opacity-[.13] mb-1'>
        ...
        <div>
            <button className='border rounded-sm border-emerald-700 border-opacity-[.25] px-[1rem] py-[.13rem]'>Join</button>
        </div>
    </div>
  )
}

export default FindGroupsLists